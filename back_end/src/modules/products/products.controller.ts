...
export class ProductsController {
  ...
  @Roles('ADMIN')
  @Get('discount/:id')
  getDiscountByProductId(@Param('id') id: string) {
    return this.productsService.getDiscountByProductId(id);
  }
  ...
  getDiscountByProduct(
    @Query() findDiscountProductsDto: FindDiscountProductsDto,
  ) {
    return this.productsService.getDiscountByProduct(findDiscountProductsDto);
  }
